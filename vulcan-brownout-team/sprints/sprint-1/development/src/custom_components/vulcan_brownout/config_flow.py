...
class VulcanBrownoutConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            # Minimal config - no user configuration needed for Sprint 1
        ...
        # Show a simple form (no config options in Sprint 1)
    ...
    async def async_step_import(self, import_data: Dict[str, Any]) -> FlowResult:
        ...
        # Not used in Sprint 1, but included for future YAML support
